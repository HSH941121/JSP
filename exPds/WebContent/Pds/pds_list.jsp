...
<c:forEach var="lists" items="${list}">
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000">${lists.idx }</font></td>
				<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a href="pds_view?idx=${lists.idx }&page=${page}">${lists.subject }</a></font></td>
        <td align="center" height="20"><font face="돋움" size="2">${lists.filename }</td>
				<td align="left" height="20"><font face="돋움" size="2">${lists.name }</font></td>
				<td align="left" height="20"><font face="돋움" size="2">${lists.regdate }</font></td>
				<td align="center" height="20"><font face="돋움" size="2">${lists.readcnt }</font></td> 	      
			</tr>
			</c:forEach>  	   
</c:if>
      <tr>
...
<form name="search_pds" method="post" action="pds_list">
