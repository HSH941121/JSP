...
<c:forEach var="lists" items="${list}">
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="Board?cmd=board_view&idx=${lists.idx }&page=${page}">${lists.subject }</a></td>
					<td align="center" height="20"><font face="돋움" size="2">
					<a class="list" href="mailto:ein1027@nate.com">${lists.name }</a></font></td>
				<td align="center" height="20"><font face="돋움" size="2">${lists.regdate.substring(0,10) }</font></td>
				<td align="center" height="20"><font face="돋움" size="2">
				${lists.readcnt }</font></td>
		</tr>
</c:forEach>
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="search" action="board_list.do" method="post">	
